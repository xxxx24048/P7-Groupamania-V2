<template>
    <div class="login">
        <div class="login-insert">
            ...
            <p class="login-insert-msg p-greythin">Sur le réseau social</p>
            <p class="login-insert-msg p-red">Groupomania</p>
        ...
        <div class="login-container">
            <form class="login-container-form" @submit="logUser">
                ...
                <div>
                    <span id="connectErrorMsg" v-show="errorPassword" class="login-container__errormsg">Mot de passe ou adresse mail incorrecte.</span>
